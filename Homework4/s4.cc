...
File:    s4.cc
Purpose: Calculates albedo using 3 images under different lighting conditions
*/
...
// TODO: rewrite using format for s4
int main(int argc, char **argv)
{
  ...
  const string output_filename(argv[6]);
  ...
  // Generate 3D object
  StereoObject myObject = StereoObject(&image1, &image2, &image3, S_inverse, threshold);
  Image output_image;

  myObject.drawAlbedos(&output_image);
